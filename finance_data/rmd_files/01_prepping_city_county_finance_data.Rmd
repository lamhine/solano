...
knitr::opts_knit$set(root.dir = '/Users/angelmr/solano_sr/finance_data/')
```
...
county_fin_20 <- county_fin_20[c(1:3,9,15,21,27,39)]
...
county_sum_20 <- county_sum_20[c(2:5)]
county_sum_20 %<>%
  mutate(total_revenues = revenues_govfunds + revenues_propfunds)
...
county_fin_17 <- county_fin_17[c(1:3,9,15,21,27,39)]

# summary stats
county_sum_17 <- read_excel("data/raw/county/CountiesRawData_20181228.xlsx", sheet = 39, na = "NULL")
county_sum_17 %>% glimpse()
...
county_sum_17 <- county_sum_17[c(2:5)]
county_sum_17 %<>%
  mutate(total_revenues = revenues_govfunds + revenues_propfunds)

# combining
county_17 <- left_join(x = county_sum_17,
                    y = county_fin_17,
                    by = c("entity_id", "year"))
...
# summary stats
county_sum_16 <- read_excel("data/raw/county/CountiesRawData_20180613.xlsx", sheet = 41, na = "NULL")
...
county_sum_16 <- county_sum_16[c(1:5)]
county_sum_16 %<>%
  mutate(total_revenues = revenues_govfunds + revenues_propfunds)
...
county_20 <- county_20[c(6,1:5,7:16)]
county_17 <- county_17[c(6,1:5,7:16)]

county <- rbind(county,county_20,county_17)
county %<>%
  arrange(county_name)
